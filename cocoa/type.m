...
- (void) write: (id <TProtocol>) outProtocol {
  ...
  if (__client_key_isset) {
    if (__client_key != nil) {
      [outProtocol writeFieldBeginWithName: @"client_key" type: TType_STRING fieldID: 3];
  ...
  if (__client_secret_isset) {
    if (__client_secret != nil) {
      [outProtocol writeFieldBeginWithName: @"client_secret" type: TType_STRING fieldID: 4];
