...
- (CommentList *) get_comment: (NSString *) access_token : (int64_t) id;  // throws TException
- (void) make_comment: (NSString *) access_token : (int64_t) id : (NSString *) text;  // throws TException
